                            ...
                            <div class="sales report">
                                ...
                                :</h2><br><br>
                                        ...
                                        while($row = $rs_result->fetch_assoc()) {
                                            ...
                                            <div class="panel panel-default panel-horizontal">
                                                <div class="panel-heading text-center" style="width:10em;">
                                                    <img src="<?php if ($_SESSION['username']== $row['member_name']) echo $row["p_pic"];?>" alt="" class="img-responsive">
                                                    <hr/>
                                                    <span><h5><?php if ($_SESSION['username']== $row['member_name'])echo $row["product_id"];?></h5><span>
                                                    </div>

                                                    <div class="panel-body"> 
                                                        <div class="col-xs-12 col-md-12 section-box">
                                                            <h2><div class="" style="padding-top: 20px;"><?php if ($_SESSION['username']== $row['member_name']) echo $row["p_name"];?></div></h2>
                                                            <br>

                                                            <p>OFFICIAL 

                                                                <a href="<?php if ($_SESSION['username']== $row['member_name']) echo $row["p_site"];?>" target="_blank"><span class="glyphicon glyphicon-new-window">
                                                                </span></a>
                                                            ...
                                                            <p>something new
                                                                ...
                                                                <a href="single.php?<?php echo $row["product_id"];?>" target="_blank"><span class="glyphicon glyphicon-new-window">
                                                                </span></a>

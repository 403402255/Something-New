...
//---product---
    ...
    $sql = " SELECT *  FROM products WHERE brand_id = ".$bid." AND category_id = 1 AND `p_name` like '%".$_POST['search']."%' AND  p_price like '%NT$%' ORDER BY CONVERT(REPLACE (p_price, 'NT$', ''),UNSIGNED INTEGER) DESC LIMIT 0,18";

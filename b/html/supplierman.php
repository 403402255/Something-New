        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#" class="waves-effect"><i class="fa fa-user fa-fw" aria-hidden="true"></i><span class="hide-menu">合作廠商管理</span></a>
                    </li>
                    <li>
                        <a href="mail.php" class="waves-effect"><i class="fa fa-table fa-fw" aria-hidden="true"></i><span class="hide-menu">輸出/寄送報表</span></a>
                    </li>
...
while($row = $rs_result->fetch_assoc()) {
    ?> <tr>
                                            ...
                                            <td><?php echo $row["brandmanager"];?></td>
                                            <td><?php echo $row["manager_mail"];?></td>
                                            <td>admin</td>
                                            <td><div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> <a href="#" target="_blank" class="btn btn-danger pull-right m-l-20 btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light">編輯</a></td>

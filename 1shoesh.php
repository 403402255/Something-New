...
//---product---
    ...
    $sql = " SELECT *  FROM products WHERE brand_id = ".$bid." AND category_id = 3 AND p_price like '%NT$%' ORDER BY CONVERT(REPLACE (p_price, 'NT$', ''),UNSIGNED INTEGER) DESC LIMIT 0,18";

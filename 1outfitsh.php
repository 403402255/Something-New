...
//---product---
    ...
    $sql = " SELECT *  FROM products WHERE brand_id = ".$filter." AND category_id = 2 AND p_price like '%NT$%' ORDER BY CONVERT(REPLACE (p_price, 'NT$', ''),UNSIGNED INTEGER) DESC LIMIT 0,18";
